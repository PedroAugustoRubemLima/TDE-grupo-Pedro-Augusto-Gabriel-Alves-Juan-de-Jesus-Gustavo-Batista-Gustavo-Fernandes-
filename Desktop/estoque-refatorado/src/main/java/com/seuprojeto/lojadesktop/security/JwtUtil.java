...
/**
 * Utilitário JWT — geração, extração e validação de tokens.
...
public class JwtUtil {
    ...
    public String generateToken(Funcionario funcionario) {
        ...
        return createToken(claims, funcionario.getUsuario());
    }
    ...
    public Boolean validateToken(String token, Funcionario funcionario) {
        if (funcionario == null || !funcionario.getAtivo()) {
            return false;
        }
        final String username = extractUsername(token);
        return username.equals(funcionario.getUsuario()) && !isTokenExpired(token);
    }
}
